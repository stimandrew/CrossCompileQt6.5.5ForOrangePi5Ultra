...
```
cd ~
wget https://raw.githubusercontent.com/stimandrew/CrossCompileQtForOrangePi5Ultra/blob/main/install_packages_target.sh
...
```
cd ~
wget https://raw.githubusercontent.com/stimandrew/CrossCompileQtForOrangePi5Ultra/blob/main/install_packages_host.sh
